...
class Annotation {
    ...
    public final function __construct($data = array(), $target = false) {
        ...
        if (isset(self::$creationStack[$class])) {
            throw new AnnotationException("Circular annotation reference on '$class'", 5000, $reflection->getFileName());
        ...
        foreach ($data as $key => $value) {
            ...
            if ($reflection->hasProperty($key)) {
                ...
                throw new AnnotationException("Property '$key' not defined for annotation '$class'", 5000, $reflection->getFileName());
